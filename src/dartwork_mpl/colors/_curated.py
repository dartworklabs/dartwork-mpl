...
CURATED_META: dict[str, dict[str, str]] = {
    ...
    "neon": {
        ...
        "intent": "MAXIMUM chroma — the loudest legal categorical, at the sRGB gamut edge. Up to 8 vivid categories on dark UI or hero moments.",
    ...
    "ember": {
        ...
        "family": "Tone",
        "band": "warm · vibrant",
        "intent": "The saturated WARM categorical — brick, coral, ochre, gold, olive, pink, and clay plus a cool-neutral anchor. Golden-hour energy without earth's muteness.",
