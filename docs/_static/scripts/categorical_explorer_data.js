const PALETTES = {
    ...
    bold:        { name:"Bold", fam:"Spectrum", band:"punchy · curated high-contrast",
      ...
      intent:"MANY categories with maximum punch — a curated, high-contrast set rather than an even rainbow spread. For presentations, posters, and dashboards that must pop, where each category should grab attention from across the room.",
