const PALETTES = {
    ...
    teal_seq:    { name:"Teal", fam:"Sequential", band:"very-narrow · single hue",
      ...
      design:"One hue (house teal, CIELAB h≈182) held constant; 8 steps on a monotonic L* ramp 32→94, chroma peaking mid. Being a pure lightness ramp makes it the most B&W-perfect palette.",
    ...
    indigo_seq:  { name:"Indigo", fam:"Sequential", band:"very-narrow · single hue",
      ...
      design:"Single indigo hue (CIELAB h≈280) on a monotonic L* ramp 32→94. A pure lightness ramp ⇒ flawless B&W; pairs as the cool member of the sequential set.",
      application:"Heatmap rows, ordered bars, area, ribbons. Reads as rank.",
      bw:"min ΔL* 8.6", cvd:"d8.9 / p8.6 / t8.9" },
    coral_seq:   { name:"Coral", fam:"Sequential", band:"very-narrow · single hue",
    ...
    warm_cool:   { name:"Warm / Cool", fam:"Duo", band:"medium · 180° split",
      ...
      design:"4 warm + 4 cool hues (≈180° apart), each an internal L* ramp; even ladder 38→90. Hue split groups, lightness separates within.",
    ...
    trustworthy: { name:"Trustworthy", fam:"Balanced", band:"medium-wide · teal + neutrals",
      ...
      design:"6 evenly-spaced hues anchored on house teal + 2 neutrals, muted chroma (no neon), staggered even L* ladder 38→88. Built to never tangle or shout.",
    ...
    muted:       { name:"Pastel", fam:"Muted", band:"medium-wide · low chroma",
    ...
    gray_seq:    { name:"Neutral Gray", fam:"Neutral", band:"neutral · hue-free L* ramp",
    ...
    teal_amber_div: { name:"Teal ↔ Amber", fam:"Diverging", band:"two-ended · pale center",
    ...
    focus:       { name:"Teal Accent", fam:"Emphasis", band:"1 teal accent + 7 neutrals",
      cols:["#065a51","#5c646b","#70787f","#848d93","#99a2a9","#aeb7be","#c4cdd5","#dae4eb"],
      ...
      design:"Slot 0 = house teal (salient), slots 1-7 = graded neutrals on an even L* ladder 34→90. Pair with Warm Accent for the warm-highlight version, or combine the two accent colors to highlight a second series.",
      application:"Single-series emphasis in line / bar charts, explanatory figures, slide builds.",
      bw:"min ΔL* 7.8", cvd:"d7.3 / p7.3 / t7.3" },
    focus_warm:  { name:"Warm Accent", fam:"Emphasis", band:"1 warm accent + 7 neutrals",
      cols:["#8d302b","#5c646b","#70787f","#848d93","#99a2a9","#aeb7be","#c4cdd5","#dae4eb"],
      ...
      design:"Slot 0 = coral (h≈32, salient), slots 1-7 = graded neutrals, even L* ladder 34→90.",
      application:"Single-series emphasis where a warm highlight reads better (e.g., risk / attention).",
      bw:"min ΔL* 7.8", cvd:"d7.3 / p7.3 / t7.3" },
  };
const ORDER = ["teal_seq","indigo_seq","coral_seq","teal_indigo","forest","warm_cool","blue_orange","teal_coral","trustworthy","corporate","muted","dusty","spectrum","bold","accessible","gray_seq","warm_gray","cool_gray","focus","focus_warm","coolwarm","teal_amber_div","earth","jewel"];
const VB='0 0 100 56';
  const P = {
