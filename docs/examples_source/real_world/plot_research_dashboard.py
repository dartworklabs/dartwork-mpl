...
fig, ax1 = plt.subplots(figsize=(dm.cm2in(15), dm.cm2in(10)), dpi=300)
...
ax1.set_ylim(0, 500)
ax1.set_xticks(x)
ax1.set_xticklabels(phases, fontsize=dm.fs(-1), rotation=45, ha="right")
...
ax1.set_title(
    "Throughput & Processing Efficiency", fontsize=dm.fs(1), fontweight="bold"
)
...
ax.set_title("Accuracy by Method", fontsize=dm.fs(1), fontweight="bold")
