...
ax.fill_between(x, y_true - 0.15, y_true + 0.15,
...
ax.hist(data1, bins=25, color=dm.pseudo_alpha('tw.teal500', 0.6, background='white'),
...
bp = ax.boxplot(groups, patch_artist=True, widths=0.6,
                medianprops=dict(color='oc.red7', lw=dm.lw(0)))
