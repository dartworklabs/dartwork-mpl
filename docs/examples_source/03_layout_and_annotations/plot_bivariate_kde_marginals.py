...
contour = ax_joint.contourf(X, Y, Z, levels=12, cmap='dc.deep_sea', alpha=0.85, zorder=2)
...
fig.suptitle("Bivariate Joint Distribution (EDA)", 
             fontsize=dm.fs(1.5), weight='bold', y=0.98)
