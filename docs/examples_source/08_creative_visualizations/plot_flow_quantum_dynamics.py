...
colors_flow = dm.cspace("dc.violet5", "dc.teal1", n=256, space="oklch")
...
particle_colors = dm.cspace("dc.red2", "dc.orange2", n=n_particles)
...
title.set_path_effects(
    [path_effects.withStroke(linewidth=dm.lw(1), foreground="dc.violet2")]
)
