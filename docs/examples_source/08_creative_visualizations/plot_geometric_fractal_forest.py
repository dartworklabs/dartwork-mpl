...
fig, ax = plt.subplots(figsize=dm.figsize("14cm", 1.111))
...
def draw_fractal_tree(ax, x, y, angle, length, depth, max_depth, colors):
    ...
    if depth >= max_depth - 1:
        leaf_colors = dm.cspace("dc.forest2", "dc.earth2", n=10)
...
branch_colors = dm.cspace("dc.earth4", "dc.forest3", n=10)
...
# Ground and stars
ax.fill_between([-6, 6], -5, -6, color="dc.earth5", alpha=0.8)
for _ in range(50):
