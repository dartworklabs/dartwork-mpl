...
for h in hues:
    ...
    ax.bar(h, 1, width=bar_width, color=c.to_rgb(), edgecolor="none")

ax.set_xlim(0, 360)
ax.set_ylim(0, 1)
ax.set_xticks([0, 60, 120, 180, 240, 300, 360])
ax.set_xticklabels(
    ["0°", "60°", "120°", "180°", "240°", "300°", "360°"], fontsize=dm.fs(-0.5)
)
ax.set_yticks([])
...
fig, axes = plt.subplots(2, 1, figsize=(dm.cm2in(15), dm.cm2in(8)), dpi=300)
...
ax_rgb.set_xticks([])
ax_rgb.set_yticks([])
ax_rgb.set_title("RGB Interpolation (blue to yellow)", fontsize=dm.fs(0.5))
...
ax_oklch.set_xticks([])
ax_oklch.set_yticks([])
ax_oklch.set_title("OKLCH Interpolation (blue to yellow)", fontsize=dm.fs(0.5))
