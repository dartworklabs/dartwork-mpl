...
ax1.legend(loc="upper right", fontsize=dm.fs(-1), frameon=False)
...
ax2.legend(loc="upper right", fontsize=dm.fs(-1), frameon=False)
...
ax3.legend(loc="upper right", fontsize=dm.fs(-1), frameon=False)
