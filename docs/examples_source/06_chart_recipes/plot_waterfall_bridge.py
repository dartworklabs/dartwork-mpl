...
The chart demonstrates dartwork-mpl's color palette (``dc.green2`` for
positive contributions, ``dc.red2`` for negative contributions), subtle
...
for i, v in enumerate(values):
    if is_total[i]:
        ...
        colors.append("dc.green2" if v >= 0 else "dc.red2")
