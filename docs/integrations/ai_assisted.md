...
fig, ax = plot_signal(data, color='dc.bold2', linewidth=1.2)
dm.save_and_show(fig)
```

**Why this works better with AI:**

- "Change the line color to `dc.bold2`" → AI modifies one argument
...
| ------------------------------------------ | ------------------------------ |
| "Change color to `dc.bold2`"                | "Make it a bit redder"         |
