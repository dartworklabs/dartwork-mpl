...
WIDGETS = [
    ...
    # tutorials.md, recipes.md, layout.md → page depth 1 → "../_static/".
    {
        ...
        "wid": "dm-cmp-l2-bar",
        "after": "../_static/landing_pocs/poc_02_bar_after.svg",
        "before": "../_static/landing_pocs/poc_02_bar_before.svg",
        "alt": "Grouped bar with value labels",
    },
    {
        "out": "_static/wipe_l3_scatter.html",
        "wid": "dm-cmp-l3-scatter",
        "after": "../_static/landing_pocs/poc_03_scatter_after.svg",
        "before": "../_static/landing_pocs/poc_03_scatter_before.svg",
        "alt": "Scatter with OLS fit",
    },
    {
        "out": "_static/wipe_l4_dual.html",
        "wid": "dm-cmp-l4-dual",
        "after": "../_static/landing_pocs/poc_04_dual_after.svg",
        "before": "../_static/landing_pocs/poc_04_dual_before.svg",
        "alt": "Dual-axis revenue / margin dashboard",
    },
    {
        "out": "_static/wipe_l6_stacked.html",
        "wid": "dm-cmp-l6-stacked",
        "after": "../_static/landing_pocs/poc_06_stacked_after.svg",
        "before": "../_static/landing_pocs/poc_06_stacked_before.svg",
        "alt": "Stacked area composition",
    },
    {
        "out": "_static/wipe_l8_violin.html",
        "wid": "dm-cmp-l8-violin",
        "after": "../_static/landing_pocs/poc_08_distribution_after.svg",
        "before": "../_static/landing_pocs/poc_08_distribution_before.svg",
    ...
    # ── Quickstart compare (embedded from usage_guide/quickstart.md) ──
    {
        ...
        "after": "../_static/compare_after.svg",
        "before": "../_static/compare_before.svg",
